...
In this example, we will use two example illustrations, which are the portable network graphics (.png) files 'Picture1.png' and 'Picture2.png', which can be downloaded from the GitHub repository.
